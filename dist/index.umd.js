(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['russian-requisites-validation'] = {}));
  ...
  var _objectSpread = objectSpread.exports;
  ...
  var _typeof__default = _interopDefaultLegacy$1(_typeof);
  var _objectSpread__default = _interopDefaultLegacy$1(_objectSpread);
  var _classCallCheck__default = _interopDefaultLegacy$1(_classCallCheck);
  var _createClass__default = _interopDefaultLegacy$1(_createClass);
  var _possibleConstructorReturn__default = _interopDefaultLegacy$1(_possibleConstructorReturn);
  var _getPrototypeOf__default = _interopDefaultLegacy$1(_getPrototypeOf);
  var _assertThisInitialized__default = _interopDefaultLegacy$1(_assertThisInitialized);
  var _inherits__default = _interopDefaultLegacy$1(_inherits);
  var consoleLogger = {
    type: 'logger',
  ...
  class Validator {
      ...
      static async getInstance(options) {
          ...
          instance._locale = await i18next_1.init({
              lng: 'en',
              ...options,
